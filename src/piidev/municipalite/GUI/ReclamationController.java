...
import piidev.municipalite.entities.Reclamation;
...
//                erreur = erreur + ("Pas de caractere permit dans le telephone\n");
    ...
    @FXML
    private void Statistic(MouseEvent event) {
    ...
    private void pdf(MouseEvent event) {
        ...
        if (selectedReclamation == null) {
            ...
            alert.setHeaderText("Aucune Reclamation sélectionnée");
            alert.setContentText("Veuillez sélectionner une Reclamation de la liste.");
            alert.showAndWait();
            return;
        }
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\raedm\\OneDrive\\Bureau\\FICHIER\\Reclamation\\ListeReclamation.pdf"));
            document.open();
